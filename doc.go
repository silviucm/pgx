...
github.com/silviucm/pgx/stdlib to use pgx as a database/sql compatible driver.
...
pgx uses the github.com/silviucm/pgx/pgtype library to support more types. See
